...
- [Comparative assembly hub / "snake track"](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4296145/) (UCSC based)
...
- [LibrAlign](http://bioinfweb.info/LibrAlign/)
...
- [Dotter](https://www.biorxiv.org/content/10.1101/589879v1.full.pdf)
...
metadata. See [TOOLS.csv](TOOLS.csv). The formatting on this is not perfect and
if you are reading into R use `read.table('TOOLS.csv', fill=T)`. PRs
...
This README.md and TOOLS.csv are CC0
